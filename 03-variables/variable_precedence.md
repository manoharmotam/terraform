...
### Here's how the prority of variables work in terraform
 ...
 1. The image id provided above for the ami key is givem high precendence over the one provided in the value for that key in main.tf, variables.tf or tfvars file
